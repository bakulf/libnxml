...
static void __nxml_namespace_free_item(nxml_data_t *e) {
  nxml_namespace_t *ns;
  nxml_data_t *child;
...
static void __nxml_namespace_free(nxml_t *nxml) {
  nxml_data_t *e;
...
int __nxml_namespace_parse_add(nxml_data_t *data, char *prefix,
                               char *namespace) {
  nxml_namespace_t *ns;
...
static int __nxml_namespace_find_item(nxml_t *nxml, nxml_data_t *e) {
  nxml_data_t *child;
  nxml_attr_t *att;
...
static int __nxml_namespace_find(nxml_t *nxml) {
  nxml_data_t *e;
...
static void __nxml_namespace_associate_attribute(struct __nxml_data_ns_t *list,
                                                 nxml_attr_t *e) {
  int i;
...
static void __nxml_namespace_associate_item(struct __nxml_data_ns_t *list,
                                            nxml_data_t *e) {
  int i;
  int len;
  int k;
...
static void __nxml_namespace_associate(struct __nxml_data_ns_t **list,
                                       nxml_data_t *root) {
  nxml_data_t *e;
  nxml_namespace_t *ns;
...
static void __nxml_namespace_connect(nxml_t *nxml) {
  nxml_data_t *e;
