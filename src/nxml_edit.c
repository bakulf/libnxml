...
nxml_error_t nxml_doctype_element(nxml_t *nxml, nxml_doctype_t **data) {
  if (!data || !nxml)
    return NXML_ERR_DATA;
...
nxml_error_t nxml_get_string(nxml_data_t *data, char **string) {
  if (!data || !string)
    return NXML_ERR_DATA;
...
nxml_error_t nxml_find_attribute(nxml_data_t *data, char *name,
...
nxml_error_t nxml_find_namespace(nxml_data_t *data, char *name,
